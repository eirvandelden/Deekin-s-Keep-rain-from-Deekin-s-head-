...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { description: @equipment.description, name: @equipment.name, price: @equipment.price, xml: @equipment.xml }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { description: @equipment.description, name: @equipment.name, price: @equipment.price, xml: @equipment.xml }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
